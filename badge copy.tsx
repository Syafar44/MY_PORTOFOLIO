...
export default function Badge({
  ...
  return (
    <>
      ...
      <motion.div
        ref={badgeRef}
        className={`${isMobile ? "relative mx-auto" : "absolute"} flex flex-col ${isMobile ? "w-[320px] h-110" : "w-95 h-125"} rounded-2xl overflow-hidden ${!isMobile ? "cursor-grab active:cursor-grabbing" : ""}`}
        style={{
          x: isMobile ? 0 : x,
          y: isMobile ? 0 : y,
