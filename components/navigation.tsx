      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <button
            ...
            className="text-xl font-bold text-[#F9F6C4] hover:opacity-80 transition-opacity"
          >
            @syafar.dev
          </button>
            ...
            {navItems.map((item) => (
              <button
                ...
                className={`capitalize transition-colors font-medium ${
                  activeSection === item ? "text-[#F9F6C4]" : "text-muted-foreground hover:text-foreground"
                }`}
              >
                {item}
              </button>
            ...
            {navItems.map((item) => (
              <button
                ...
                className={`capitalize text-left px-2 py-2 rounded transition-colors ${
                  activeSection === item ? "text-[#F9F6C4] bg-[#F9F6C4]/10" : "text-muted-foreground hover:text-foreground"
                }`}
              >
                {item}
              </button>
